...
# filtro de fondo
# En constants.py
NIGHT_COLOR = (10, 10, 40)  # Azul oscuro
NIGHT_OPACITY = 160         # 0 es transparente, 255 es oscuridad total

# --- NUEVO: ANIMACIÓN DEL PERRO ---
# Duración de cada frame de animación del perro en milisegundos
DOG_FRAME_DURATION_MS = 100 # Puedes ajustar este valor para la velocidad